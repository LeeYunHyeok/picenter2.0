		...
		<div class="content magin_t45">
			...
			<div class="grid_top">
                ...
                <table class="user_info">
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: center; background-color: #de6e4ed; width:4vw">업무구분</td>
                            ...
                            <td style="text-align: center; background-color: #de6e4ed; width:3vw">상태</td>
                            <td>
                            ...
                            <td style="text-align: center; background-color: #de6e4ed; width:4vw;">문서명</td>
                            <td style="width:10vw"><input type="text" style="style="width: 8vw; font-size: .85vw;" size="20" id="schPath" placeholder="문서명을 입력하세요"></td>
                            <td style="text-align: center; background-color: #de6e4ed; width:4vw">기안자</td>
                            <td style="width:10vw"><input type="text" style="style="width: 8vw; font-size: .85vw;" size="10" id="schUserNm" placeholder="기안자명을 입력하세요"></td>
                            <td style="text-align: center; background-color: #de6e4ed; width:4vw">문서기안일</td>
                            <td style="width:17vw;">
