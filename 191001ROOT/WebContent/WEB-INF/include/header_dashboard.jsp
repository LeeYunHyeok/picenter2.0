...
$(document).ready(function () {
	...
	if ("#${menuKey}".length != 1) $("#${menuKey}").addClass('on');
	...
	<div class="wrap_main">
		...
		<header id="header">
			...
			<div class="container">
				<!-- logo -->
				<div class="img_logo">
					<a href="<%=request.getContextPath()%>/piboard" title="piboard"><h1>NH농협은행</h1></a>
				</div>
				<div style="position: absolute; left: 220px; top: 20px; color: #fff; font-size: 1.2em;">서버 내 개인정보 검색 관리</div>
				<!-- logo -->
				...
				<div class="user">
					...
					<img src="${pageContext.request.contextPath}/resources/assets/images/btn_setting.png" id="btnLogout" title="비밀번호변경" style="margin-left: 5px; cursor: pointer;">
